...
import 'package:timetocode/features/1_story_mode/minigames/drag_and_drop_code/presentation/widgets/block.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DragTarget<String>(
      ...
      onAcceptWithDetails: (data) =>
          ref.read(dndControllerProvider.notifier).dropItem(zoneId, data.data),
    );
  }
}
