...
mixin _$DndState {
 ...
 DragAndDropModel? get currentDragAndDrop; List<DraggableModel>? get availableOptions; List<DropZoneModel>? get dropZones; bool? get isLoading;
...
@override
int get hashCode => Object.hash(runtimeType,currentDragAndDrop,const DeepCollectionEquality().hash(availableOptions),const DeepCollectionEquality().hash(dropZones),isLoading);

@override
String toString() {
  return 'DndState(currentDragAndDrop: $currentDragAndDrop, availableOptions: $availableOptions, dropZones: $dropZones, isLoading: $isLoading)';
}
...
@useResult
$Res call({
 DragAndDropModel? currentDragAndDrop, List<DraggableModel>? availableOptions, List<DropZoneModel>? dropZones, bool? isLoading
});
...
/// Create a copy of DndState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentDragAndDrop = freezed,Object? availableOptions = freezed,Object? dropZones = freezed,Object? isLoading = freezed,}) {
...
as List<DropZoneModel>?,isLoading: freezed == isLoading ? _self.isLoading : isLoading // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
/// Create a copy of DndState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DragAndDropModel? currentDragAndDrop,  List<DraggableModel>? availableOptions,  List<DropZoneModel>? dropZones,  bool? isLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DndState() when $default != null:
return $default(_that.currentDragAndDrop,_that.availableOptions,_that.dropZones,_that.isLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DragAndDropModel? currentDragAndDrop,  List<DraggableModel>? availableOptions,  List<DropZoneModel>? dropZones,  bool? isLoading)  $default,) {final _that = this;
switch (_that) {
case _DndState():
return $default(_that.currentDragAndDrop,_that.availableOptions,_that.dropZones,_that.isLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DragAndDropModel? currentDragAndDrop,  List<DraggableModel>? availableOptions,  List<DropZoneModel>? dropZones,  bool? isLoading)?  $default,) {final _that = this;
switch (_that) {
case _DndState() when $default != null:
return $default(_that.currentDragAndDrop,_that.availableOptions,_that.dropZones,_that.isLoading);case _:
  return null;
...
class _DndState implements DndState {
  const _DndState({this.currentDragAndDrop, final  List<DraggableModel>? availableOptions, final  List<DropZoneModel>? dropZones, this.isLoading}): _availableOptions = availableOptions,_dropZones = dropZones;
...
@override
int get hashCode => Object.hash(runtimeType,currentDragAndDrop,const DeepCollectionEquality().hash(_availableOptions),const DeepCollectionEquality().hash(_dropZones),isLoading);
...
/// Create a copy of DndState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentDragAndDrop = freezed,Object? availableOptions = freezed,Object? dropZones = freezed,Object? isLoading = freezed,}) {
